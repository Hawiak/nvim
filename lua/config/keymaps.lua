...
vim.keymap.set("n", "<leader>bC", close_all_bufs, { desc = "Close all buffers (except neo-tree)" })
vim.keymap.set("n", "<leader>ba", close_all_bufs, { desc = "Close all buffers (except neo-tree)" })
return M
